...
with tf.Session(config = conf) as Sess:
	...
	while Step < NumIteration:
		...
		# execute the session
		Summary, _, Acc, L, P = Sess.run([SummaryOp, Optimizer, Accuracy, Loss, predictions], feed_dict = {InputData: Data, InputLabels: Label})
